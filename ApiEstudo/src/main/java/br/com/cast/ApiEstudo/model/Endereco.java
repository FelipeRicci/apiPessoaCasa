...
import br.com.cast.ApiEstudo.dto.EnderecoDTO;

@Entity
@Table(name = "endereco", schema = "ajax")
public class Endereco {

	@Id
	@SequenceGenerator(sequenceName = "endereco_id_seq", name = "gerador_end_seq", allocationSize = 1, schema = "ajax")
	...
	public static void fromDTO(Endereco endereco, EnderecoDTO enderecoDTO) {
